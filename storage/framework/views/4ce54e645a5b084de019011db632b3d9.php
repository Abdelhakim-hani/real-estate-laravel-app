  ...
  <div class="register-card">
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>">
      ...
      <div class="text-center mt-3">
        <small>Déjà inscrit ? 
          <a href="<?php echo e(route('login')); ?>" style="color: #0d9488; text-decoration: none;">Connectez-vous</a>
        </small>
      </div>
    </form>
  </div>
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PRO\Downloads\Agence-Immobiliere-main\Agence-Immobiliere-main\resources\views/auth/register.blade.php ENDPATH**/ ?>