...
<section class="py-5 bg-light">
  <div class="container">
    ...
    <div class="text-center mt-5">
      <a href="<?php echo e(route('contact')); ?>" class="btn btn-teal px-4 py-2 rounded-pill shadow">Demander un service</a>
    </div>
  </div>
</section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PRO\Downloads\Agence-Immobiliere-main\Agence-Immobiliere-main\resources\views/services.blade.php ENDPATH**/ ?>