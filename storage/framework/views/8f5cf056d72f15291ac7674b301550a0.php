...
<section class="bg-white py-5 shadow-sm rounded-4 mb-5 border border-2 border-light position-relative overflow-hidden search-section">
  ...
  <i class="bi bi-search"></i> Recherchez Votre Bien Idéal
    ...
    <!-- Search Form -->
   <form method="GET" action="<?php echo e(route('properties.search')); ?>" class="row g-4 floating-labels">
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PRO\Downloads\Agence-Immobiliere-main\Agence-Immobiliere-main\resources\views/home.blade.php ENDPATH**/ ?>