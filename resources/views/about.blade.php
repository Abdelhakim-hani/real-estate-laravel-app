...
@section('title', 'À propos de Immo')
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 mb-4 mb-md-0 animate-fadeup">
        <img src="{{ asset('https://cdndailyexcelsior.b-cdn.net/wp-content/uploads/2022/07/real-estate.jpg') }}" alt="Notre agence" class="img-fluid rounded-4 shadow-lg">
      </div>
